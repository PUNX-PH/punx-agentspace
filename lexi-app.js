...
document.getElementById("sentPromptOkBtn").addEventListener("click", function () {
  ...
  window.location.href = "https://punx-agentspace.vercel.app/lexi"; // CHANGE this to your real homepage!
});

document.getElementById("goHomeBtn").addEventListener("click", function () {
  window.location.href = "https://punx-agentspace.vercel.app/lexi"; 
});
